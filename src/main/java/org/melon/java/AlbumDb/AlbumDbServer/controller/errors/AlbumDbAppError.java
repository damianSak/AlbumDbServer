...
public class AlbumDbAppError {

    private final String apiVersion;
    private final ErrorBlock error;

    public AlbumDbAppError(final String apiVersion, final String code, final String message, final String domain,
    ...
    public static AlbumDbAppError fromDefaultAttributeMap(final String apiVersion,
